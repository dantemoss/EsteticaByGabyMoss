...
const FormMaps = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_s0elo4h', 'template_83xr5ns', form.current, 'APenBFkj5CSLrf0LY')
            .then((result) => {
                    ...
                    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                        <form ref={form} onSubmit={sendEmail}>
                            ...
                            <p className="leading-relaxed mb-5 text-gray-600">
                                Cualquier Consulta o duda que tengas déjanosla en nuestro formulario.
                            </p>
                        ...
                        <p className="text-xs text-gray-500 mt-3">
                            Aclaración, el servicio de consultas puede tardar más de lo normal.
                        </p>
                    </div>
                </div>
            </section>
